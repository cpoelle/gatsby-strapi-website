...
export default function Schule({ data, pageContext, location }) {
  ...
  const bannerInfo = {
    title: "Banner Schule",
    subTitle: "Hier steht ein Subtitle für das Schulangebot der Firma.",
    color: "schoolColor",
    icon: iconSchule,
  };
  ...
  const stageContent = {
    ...
    Folgende Fachrichtungen und Schwerpunkte bieten wir jeweils an: `,
    image: schoolImage,
  };
...
export const query = graphql`
  query {
    ...
    schoolGatsbyImage: file(relativePath: { eq: "content/placeholder.png" }) {
      childImageSharp {
        gatsbyImageData(
          placeholder: BLURRED
